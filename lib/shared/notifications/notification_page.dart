                ...
                children: [
                  Row(
                    children: [
                      ...
                      // 🆕 NEW: Show indicator for local notifications
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      // 🆕 NEW: Show minutes remaining for return reminders
                      if (notification.type == NotificationType.returnReminder &&
                          notification.metadata?['minutes_remaining'] != null)
                        Container(
                          padding: const EdgeInsets.symmetric(
                              horizontal: 8, vertical: 2),
                          decoration: BoxDecoration(
                            color: notification.metadata!['is_urgent'] == true
                                ? Colors.red.shade100
                                : Colors.orange.shade100,
                            borderRadius: BorderRadius.circular(10),
                          ),
                          child: Text(
                            '${notification.metadata!['minutes_remaining']} min left',
                            style: GoogleFonts.poppins(
                              fontSize: 10,
                              fontWeight: FontWeight.bold,
                              color: notification.metadata!['is_urgent'] == true
